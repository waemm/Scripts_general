...
for readp in read_pairs:
    ...
    if len(read_pairs[readp]) >= 1:
        ...
        if len(read_pairs[readp]) > 1:
	    tmp_str += "nohup /SAN/biomed/biomed6/biomed6/warren/Applications/TrimGalore/trim_galore --paired %s %s &\n"%(read1,read2)
	    ...
	    tmp_str += "nohup /SAN/biomed/biomed6/biomed6/warren/Applications/TrimGalore/trim_galore %s &\n"%(read1)
